...
import config
# from utils import load_model, infer_uploaded_image, infer_uploaded_video, infer_uploaded_webcam,infer_uploaded_webcam2,infer_uploaded_webcam3
from utils import *
# setting page layout
st.set_page_config(
    page_title="EZ deep-learning ",
    page_icon="🤖",
    layout="wide",
